...
Jeśli mimo to w logu nadal pojawia się `aapt2-...-linux` lub `Syntax error: "(" unexpected`, skorzystaj z builda CI na GitHub Actions (runner x64): `.github/workflows/android-debug-apk.yml`.
